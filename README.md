...
### 🌊 什么是 Ai ThoughtFlow Pro？

Ai ThoughtFlow Pro 是一款专为创意和效率设计的**跨平台桌面端 AI 绘图引擎**。它将 Excalidraw 的手绘美学与现代大语言模型的逻辑能力完美结合，通过“液态玻璃”设计语言提供极致的交互体验。
...
#### 下载安装
最新的各平台安装包可在 [Gitee 发行版](https://gitee.com/applexyz/ai-thought-flow-pro/releases) 页面获取：
...
Ai ThoughtFlow Pro 完全开源且免费。如果它为你的工作节省了时间，欢迎支持它的持续进化！
...
> 如果觉得 Ai ThoughtFlow Pro 对你有很大帮助或价值，可以请我喝杯咖啡支持一下，这将是我最大的创新源动力！
